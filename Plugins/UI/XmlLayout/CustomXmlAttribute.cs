...
{    
    ...
    {        
        ...
        /// </summary>
        public virtual bool UsesApplyMethod { get { return false; } }
        ...
        public enum eAttributeGroup
        {
            ...
            Dragging,                               // Applied to most elements
            Custom                                  // Special handling; this attribute will be part of a CustomXmlAttributeGroup
        }
