...
namespace UI.Xml.Tags
{
    public class TableLayoutTagHandler : ElementTagHandler
    {
        ...
        {            
            ...
            if (attributes.ContainsKey("rowBackgroundColorAlternate"))
            {
                if (!attributes.ContainsKey("useAlternateRowBackgroundColor"))
                {
                    tableLayout.UseAlternateRowBackgroundColors = true;
                }
            }

            if (attributes.ContainsKey("cellBackgroundColorAlternate"))
            {
                if (!attributes.ContainsKey("useAlternateCellBackgroundColor"))
                {
